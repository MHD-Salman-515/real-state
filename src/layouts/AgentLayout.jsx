  ...
  return (
    <NavLink
      ...
      className={({ isActive }) =>
        ...
        (isActive
          ? "bg-emerald-400/80 text-black border-emerald-300 shadow-soft"
      ...
      <div className="px-4 py-4 border-b border-white/10">
        <div className="flex items-center gap-2">
          ...
          <div className="font-semibold">
            <span className="text-emerald-200">Agent</span> Panel
          </div>
        </div>
            ...
            <div className="relative">
              <button
                ...
                className="
                  ...
                  bg-white/5 bg-gradient-to-br from-emerald-400/20 via-transparent to-cyan-400/25
                  backdrop-blur-xl
                  shadow-soft
                  transition
              ...
              >
                ...
                <span className="absolute inset-0.5 rounded-2xl bg-emerald-400/15 blur-md pointer-events-none" />
                {/* Icon */}
                <span className="relative text-lg md:text-xl text-emerald-50">
                  🔔
                </span>
                ...
                {unreadCount > 0 && (
                  <>
                    <span className="absolute -top-1 -right-1 h-4 min-w-[16px] px-1 rounded-full bg-emerald-400 text-[10px] font-bold text-black flex items-center justify-center">
              ...
              {notifOpen && (
                <div
                  className="
                    ...
                    shadow-xl shadow-emerald-500/25 backdrop-blur-2xl z-30
