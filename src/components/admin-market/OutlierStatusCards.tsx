  ...
  return (
    <section className="grid gap-3 md:grid-cols-3">
      <article className="rounded-2xl border border-white/10 bg-white/5 p-4">
        <p className="text-xs uppercase tracking-[0.14em] text-white/55">{t("Total Outliers")}</p>
        <p className="mt-2 text-xl font-semibold text-white">{total.toLocaleString()}</p>
      </article>
      <article className="rounded-2xl border border-white/10 bg-white/5 p-4">
        <p className="text-xs uppercase tracking-[0.14em] text-white/55">{t("Flagged Ratio")}</p>
        <p className="mt-2 text-xl font-semibold text-amber-200">{flaggedPct}%</p>
      </article>
      <article className="rounded-2xl border border-white/10 bg-white/5 p-4">
        <p className="text-xs uppercase tracking-[0.14em] text-white/55">{t("Anomaly Hotspot")}</p>
